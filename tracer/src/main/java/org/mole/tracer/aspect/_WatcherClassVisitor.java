...
//
//public class _WatcherClassVisitor extends ClassVisitor {
//
//    //# mediator
...
//    public _WatcherClassVisitor(ClassVisitor cv, String className, Map<String, Map<String, SimpleMethod>> simpleMethods, TracerContext context) {
//        super(ASM7, cv);
//
