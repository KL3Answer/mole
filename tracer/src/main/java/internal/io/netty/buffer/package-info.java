 ...
 * {@link internal.io.netty.buffer.ByteBuf}, has been designed from ground
 ...
 * <h3>Extensibility</h3>
 *
 * {@link internal.io.netty.buffer.ByteBuf} has rich set of operations
 * optimized for rapid protocol implementation.  For example,
 * {@link internal.io.netty.buffer.ByteBuf} provides various operations
 ...
 * {@link internal.io.netty.buffer.ByteBuf} interface rather than
 ...
 * </pre>
 * By contrast, {@link internal.io.netty.buffer.ByteBuf} does not have such
 ...
 * {@link internal.io.netty.buffer.ByteBuf} message = {@link internal.io.netty.buffer.Unpooled}.wrappedBuffer(header, body);
 *
 * // Therefore, you can even create a composite by mixing a composite and an
 * // ordinary buffer.
 * {@link internal.io.netty.buffer.ByteBuf} messageWithFooter = {@linkimport internal.io.netty.buffer.Unpooled}.wrappedBuffer(message, footer);
 *
 * // Because the composite is still a {@linkimport internal.io.netty.buffer.ByteBuf}, you can access its content
 ...
 * {@linkimport internal.io.netty.buffer.ByteBuf} b = {@linkimport internal.io.netty.buffer.Unpooled}.buffer(4);
 *
 ...
 * {@linkimport internal.io.netty.buffer.ByteBuf} is a very thin wrapper of a
