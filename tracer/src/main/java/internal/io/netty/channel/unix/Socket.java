 ...
 * under the License.
 */
package internal.io.netty.channel.unix;

import internal.io.netty.channel.ChannelException;
import internal.io.netty.util.CharsetUtil;
...
import static internal.io.netty.channel.unix.Errors.ERRNO_EINPROGRESS_NEGATIVE;
...
import static internal.io.netty.channel.unix.Errors.throwConnectException;
import static internal.io.netty.channel.unix.Errors.newIOException;
import static internal.io.netty.channel.unix.NativeInetAddress.address;
import static internal.io.netty.channel.unix.NativeInetAddress.ipv4MappedIpv6Address;
import static internal.io.netty.util.internal.ThrowableUtil.unknownStackTrace;
