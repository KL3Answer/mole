 ...
 * under the License.
 */
package internal.io.netty.channel.epoll;

import internal.io.netty.channel.DefaultFileRegion;
import internal.io.netty.channel.unix.Errors.NativeIoException;
import internal.io.netty.util.internal.NativeLibraryLoader;
import internal.io.netty.util.internal.PlatformDependent;
import internal.io.netty.util.internal.SystemPropertyUtil;
import internal.io.netty.channel.unix.FileDescriptor;
import internal.io.netty.channel.unix.NativeInetAddress;
import internal.io.netty.util.internal.ThrowableUtil;
...
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollerr;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollet;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollin;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollout;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollrdhup;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.iovMax;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingSendmmsg;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingTcpFastopen;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.kernelVersion;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.ssizeMax;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.tcpMd5SigMaxKeyLen;
import static internal.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.uioMaxIov;
import static internal.io.netty.channel.unix.Errors.ERRNO_EAGAIN_NEGATIVE;
import static internal.io.netty.channel.unix.Errors.ERRNO_EPIPE_NEGATIVE;
import static internal.io.netty.channel.unix.Errors.ERRNO_EWOULDBLOCK_NEGATIVE;
import static internal.io.netty.channel.unix.Errors.ioResult;
import static internal.io.netty.channel.unix.Errors.newConnectionResetException;
import static internal.io.netty.channel.unix.Errors.newIOException;
