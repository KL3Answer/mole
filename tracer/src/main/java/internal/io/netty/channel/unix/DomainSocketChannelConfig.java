...
public interface DomainSocketChannelConfig extends ChannelConfig {
     ...
     * {@link internal.io.netty.channel.Channel} and passed through the pipeline. If
     * {@link DomainSocketReadMode#FILE_DESCRIPTORS} is used
     * {@link FileDescriptor}s will be passed through the {@link internal.io.netty.channel.ChannelPipeline}.
     *
